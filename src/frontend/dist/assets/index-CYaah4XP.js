  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14" })
      ]
    }
  );
}
const ALL_TABS = [
  { id: "home", label: "Home", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HomeIcon, {}) },
  { id: "log", label: "Log", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(LogIcon, {}) },
  { id: "graphs", label: "Graphs", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(GraphsIcon, {}) },
  { id: "history", label: "History", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HistoryIcon, {}) },
  { id: "settings", label: "Settings", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsIcon, {}) }
];
function TabBar({
  activeTab,
  onTabChange,
  ...
  const noAnim = fps === 30;
  const orderedTabs = tabOrder.map((id) => ALL_TABS.find((t) => t.id === id)).filter((t) => !!t && !hiddenTabs.includes(t.id));
  const getScale = (idx) => {
    if (noAnim) return 1;
  ...
  const getTabIdxAtPoint = (clientX, clientY) => {
  ...
  if (layout === "side") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: orderedTabs.map((tab, idx) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              style: {
                ...
                transition: noAnim ? "none" : `transform ${theme.anim.fast} ease, color ${theme.anim.fast} ease`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    style: {
                      ...
                      transition: noAnim ? "none" : `opacity ${theme.anim.normal} ease`,
                      fontWeight: 600
                    },
                    children: tab.label
                  }
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                style: {
                  ...
                  color: isActive ? theme.colors.accent : theme.colors.textDim,
                  transform: `scale(${getScale(idx)})`,
                  transition: noAnim ? "none" : `transform ${theme.anim.fast} cubic-bezier(0.34, 1.56, 0.64, 1), color ${theme.anim.fast} ease`,
                  padding: "6px 12px",
                  borderRadius: theme.radius.md,
                  minWidth: "52px",
                  pointerEvents: "none"
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
                        ...
                        overflow: "hidden",
                        transition: noAnim ? "none" : `opacity ${theme.anim.normal} ease, max-height ${theme.anim.normal} ease`,
                        whiteSpace: "nowrap"
                      },
                      children: tab.label
                    }
...
async function getStorageUsageKB(state) {
  var _a2;
  if (state) {
    return JSON.stringify(state).length / 1024;
  }
  if ((_a2 = navigator.storage) == null ? void 0 : _a2.estimate) {
    try {
...
function StoreProvider({ children }) {
  const [state, dispatch] = reactExports.useReducer(reducer, DEFAULT_STATE);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StoreContext.Provider, { value: { state, dispatch }, children });
}
function useStore() {
...
function SectionHeader$4({ title }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: theme.colors.accent }, children: "#" }),
        " ",
        title
      ]
    }
...
function catmullRomToBezier(pts, _width, height, maxY) {
...
function SmoothChart({
  ...
  const toSvgY = (y) => height - 30 - y / maxY * (height - 50);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: fillPath, fill: `url(#${gradId})` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
            d: linePath,
        ...
        svgPts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: p.x,
        ...
        svgPts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "text",
          {
            x: p.x,
            y: height - 8,
...
function LineChart({
  ...
  const maxY = Math.max(...dataPoints.map((d) => d.y), 1);
  const toY = (y) => height - 30 - y / maxY * (height - 50);
  const pathD = dataPoints.map((p, i) => `${i === 0 ? "M" : "L"} ${p.x} ${toY(p.y)}`).join(" ");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      "aria-hidden": "true",
      ...
      children: [
        ...
        dataPoints.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "circle",
            {
              cx: p.x,
...
function GraphsTab() {
  ...
  const [chartType, setChartType] = reactExports.useState("smooth");
  const [selectedCat, setSelectedCat] = reactExports.useState("all");
  const [compare2, setCompare] = reactExports.useState(false);
  ...
  const buildDataPoints = (catFilter, days2) => {
    const step = Math.max(1, Math.floor(days2.length / 10));
    return days2.filter((_, i) => i % step === 0 || i === days2.length - 1).map((day, i, arr) => {
      const total = state.logs.filter((l) => l.date.slice(0, 10) === day && catFilter(l.categoryId)).reduce((s, l) => s + l.value, 0);
  ...
  const days = getDays();
  const catFilterFn = (catId) => {
    var _a2, _b2;
    if (selectedCat === "all") return true;
    if (selectedCat === "productive")
      return ((_a2 = state.categories.find((c) => c.id === catId)) == null ? void 0 : _a2.parentId) === "productive";
    if (selectedCat === "time-waste")
      return ((_b2 = state.categories.find((c) => c.id === catId)) == null ? void 0 : _b2.parentId) === "time-waste";
  ...
  const productiveData = buildDataPoints(
    (id) => {
      var _a2;
      return ((_a2 = state.categories.find((c) => c.id === id)) == null ? void 0 : _a2.parentId) === "productive";
    },
    days
  );
  const timeWasteData = buildDataPoints(
    (id) => {
      var _a2;
      return ((_a2 = state.categories.find((c) => c.id === id)) == null ? void 0 : _a2.parentId) === "time-waste";
    },
    days
  );
  const ChartComponent = chartType === "smooth" ? SmoothChart : chartType === "bar" ? BarChart : LineChart;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: theme.spacing.lg, paddingBottom: "100px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader$4, { title: "Graphs" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: [
          ...
          "button",
          {
            ...
            style: {
              ...
              background: selectedCat === opt.id ? `${theme.colors.accent}20` : theme.colors.surface,
              color: selectedCat === opt.id ? theme.colors.accent : theme.colors.textMuted,
              fontWeight: 600,
              fontSize: theme.font.xs,
              cursor: "pointer",
              whiteSpace: "nowrap"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: ["7d", "30d", "90d", "all"].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            "data-ocid": "graphs.filter.tab",
            ...
            style: {
              ...
              background: period === p ? `${theme.colors.accent}20` : theme.colors.surface,
              color: period === p ? theme.colors.accent : theme.colors.textMuted,
              fontWeight: 600,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: ["smooth", "line", "bar"].map((ct) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  "data-ocid": "graphs.filter.tab",
                  ...
                  style: {
                    ...
                    borderRadius: theme.radius.pill,
                    border: "none",
                    background: chartType === ct ? theme.colors.accent : "transparent",
                  ...
                  children: ct.charAt(0).toUpperCase() + ct.slice(1)
                },
                ct
              ))
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: () => setCompare(!compare2),
              style: {
                padding: "6px 14px",
                borderRadius: theme.radius.pill,
                border: `1px solid ${compare2 ? theme.colors.teal : theme.colors.border}`,
                background: compare2 ? `${theme.colors.teal}20` : theme.colors.surface,
                color: compare2 ? theme.colors.teal : theme.colors.textMuted,
                fontWeight: 600,
                fontSize: theme.font.sm,
                cursor: "pointer"
              },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: compare2 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", top: 0, left: 0, right: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ChartComponent,
            {
...
function HistoryTab() {
  ...
  const filtered = state.logs.filter((log2) => {
    const cat = state.categories.find((c) => c.id === log2.categoryId);
    const matchSearch = search.trim() === "" || (cat == null ? void 0 : cat.name.toLowerCase().includes(search.toLowerCase()));
    const matchCat = catFilter === "all" || log2.categoryId === catFilter || catFilter === "productive" && (cat == null ? void 0 : cat.parentId) === "productive" || catFilter === "time-waste" && (cat == null ? void 0 : cat.parentId) === "time-waste";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: theme.spacing.lg, paddingBottom: "100px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader$3, { title: "History" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "text",
        ...
        children: [
          ...
          "button",
          {
            ...
            style: {
              ...
              background: catFilter === opt.id ? `${theme.colors.accent}20` : theme.colors.surface,
              color: catFilter === opt.id ? theme.colors.accent : theme.colors.textMuted,
              fontWeight: 600,
              fontSize: theme.font.xs,
              cursor: "pointer",
              whiteSpace: "nowrap"
    ...
    filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "48px", marginBottom: theme.spacing.md }, children: "🕐" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: theme.font.sm }, children: state.logs.length === 0 ? "Start logging to see your history here" : "No logs match your current filter" })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: filtered.map((log2, i) => {
          const cat = state.categories.find((c) => c.id === log2.categoryId);
          const isExpanded = expanded === log2.id;
          const isProductive = (cat == null ? void 0 : cat.parentId) === "productive";
          const color = isProductive ? theme.colors.teal : theme.colors.orange;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": `history.item.${i + 1}`,
              onClick: () => setExpanded(isExpanded ? null : log2.id),
              onKeyDown: (e) => {
                if (e.key === "Enter" || e.key === " ")
                  setExpanded(isExpanded ? null : log2.id);
              },
              style: {
                background: theme.colors.surface,
                borderRadius: theme.radius.md,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: (cat == null ? void 0 : cat.name) ?? log2.categoryId
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: isProductive ? "Productive" : "Time-Waste"
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: log2.unit === "time" ? `${log2.value}h` : log2.value
                        }
                      )
                    ]
                  }
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: theme.colors.text }, children: "Category:" }),
                            " ",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: theme.colors.text }, children: "Value:" }),
                            " ",
                            log2.unit === "time" ? `${log2.value} hours` : `${log2.value}`
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: theme.colors.text }, children: "Unit:" }),
                            " ",
                            log2.unit
                          ]
                        }
                      ),
                      log2.duration && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          style: {
                            fontSize: theme.font.sm,
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: theme.colors.text }, children: "Duration:" }),
                            " ",
                            log2.duration,
                            "h"
                          ]
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: theme.colors.text }, children: "Logged at:" }),
                            " ",
                            formatDate(log2.createdAt)
                          ]
                        }
                      )
                    ]
...
function SparkChart({ data, color }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { "aria-hidden": "true", width: w, height: h, viewBox: `0 0 ${w} ${h}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: `sg-${color.slice(1)}`, x1: "0", y1: "0", x2: "0", y2: "1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: color, stopOpacity: "0.4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: color, stopOpacity: "0" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: fillD, fill: `url(#sg-${color.slice(1)})` }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "path",
      {
        d,
...
function CategoryCard({
  ...
  const dailyTotals = days.map(
    (day) => state.logs.filter(
      (l) => l.date.slice(0, 10) === day && cats.some((c) => c.id === l.categoryId)
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color }, children: "#" }),
              " ",
              label
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SparkChart, { data: dailyTotals, color })
      ]
    }
  );
}
...
function HomeTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: theme.spacing.lg, paddingBottom: "100px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: theme.spacing.lg }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader$2, { title: "Last 7 Days" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryCard, { parentId: "productive", color: theme.colors.teal }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryCard, { parentId: "time-waste", color: theme.colors.orange })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader$2, { title: "Recent Logs" }),
    recent.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: "No logs yet. Start tracking in the Log tab!"
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: recent.map((log2, i) => {
          const cat = getCategory(log2.categoryId);
          const isProductive = (cat == null ? void 0 : cat.parentId) === "productive";
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "right" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      fontWeight: 700,
                      color: isProductive ? theme.colors.teal : theme.colors.orange,
                      fontSize: theme.font.lg
                    },
                    children: log2.unit === "time" ? `${log2.value}h` : log2.value
                  }
...
const OVER_LIMIT_COLOR$1 = "#b91c1c";
function CustomSlider({ value, max, onChange, unit }) {
  const trackRef = reactExports.useRef(null);
  const [dragging, setDragging] = reactExports.useState(false);
  const [bouncing, setBouncing] = reactExports.useState(false);
  const bounceTimerRef = reactExports.useRef(
    void 0
  );
  ...
  const activeColor = isOverLimit ? OVER_LIMIT_COLOR$1 : theme.colors.accent;
  const triggerBounce = reactExports.useCallback(() => {
    setBouncing(false);
  ...
  const getValueFromEvent = reactExports.useCallback(
    (clientX) => {
  ...
  const handlePointerDown = (e) => {
    var _a2;
    e.preventDefault();
    (_a2 = trackRef.current) == null ? void 0 : _a2.setPointerCapture(e.pointerId);
    setDragging(true);
  ...
  const displayValue = unit === "time" ? `${value.toFixed(1)}h` : value.toFixed(1);
  const maxDisplay = unit === "time" ? `${max}h` : `${max}`;
  const thumbScale = dragging ? 1.2 : bouncing ? 1.35 : 1;
  const thumbSize = 22;
  const thumbTransition = dragging ? "left 0s, top 0s, transform 0.18s ease, box-shadow 0.18s ease, background 0.2s ease" : bouncing ? "left 0.35s cubic-bezier(0.25, 0.1, 0.25, 1), transform 0.45s cubic-bezier(0.34, 1.72, 0.64, 1), box-shadow 0.3s ease, background 0.2s ease" : "left 0.35s cubic-bezier(0.25, 0.1, 0.25, 1), transform 0.2s ease, box-shadow 0.3s ease, background 0.2s ease";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", padding: "14px 0" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                borderRadius: theme.radius.pill,
                background: activeColor,
                transition: dragging ? "none" : "width 0.35s cubic-bezier(0.25, 0.1, 0.25, 1), background 0.2s ease"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                borderRadius: "50%",
                background: activeColor,
                boxShadow: dragging || bouncing ? `0 0 14px ${activeColor}90` : `0 2px 6px ${activeColor}50`,
                pointerEvents: "none",
...
function UnitToggle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: ["time", "number"].map((u) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => onChange(u),
...
function LogField({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: theme.spacing.md }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(UnitToggle, { unit, onChange: onUnitChange })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: unit === "time" ? "hours" : "count"
            }
          )
        ]
      }
...
function ConfirmBar({ onUndo, onExpire }) {
  const timerRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    timerRef.current = setTimeout(onExpire, 5e3);
    return () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: "@keyframes shrink5s { from { width: 100%; } to { width: 0%; } }" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
...
const QuickLogIcon = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
    width: "18",
    height: "18",
    ...
    "aria-hidden": "true",
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Quick Log" }),
...
const FullLogIcon = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
    width: "18",
    height: "18",
    ...
    "aria-hidden": "true",
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Full Log" }),
...
function LogTab() {
  ...
  const [selectedCatId, setSelectedCatId] = reactExports.useState(
    ((_a2 = state.categories[0]) == null ? void 0 : _a2.id) ?? ""
  );
  const [values, setValues] = reactExports.useState({});
  const [units, setUnits] = reactExports.useState({});
  const [tempValue, setTempValue] = reactExports.useState(0);
  const [tempUnit, setTempUnit] = reactExports.useState("time");
  ...
  const [lastLogId, setLastLogId] = reactExports.useState(null);
  const [showConfirm, setShowConfirm] = reactExports.useState(false);
  const getUnit = (cat) => units[cat.id] ?? cat.defaultUnit;
  const getValue = (cat) => values[cat.id] ?? 0;
  const setFieldValue = (catId, v) => setValues((prev) => ({ ...prev, [catId]: v }));
  const setFieldUnit = (catId, u) => setUnits((prev) => ({ ...prev, [catId]: u }));
  const submitLog = (catIds) => {
    const now2 = /* @__PURE__ */ new Date();
    const dateStr = logDate || now2.toISOString();
    const dur = Number.parseFloat(duration) || void 0;
    const ids = [];
    const submittedCatIds = [];
    if (mode === "single") {
  ...
  const modeConfig = [
    { id: "single", label: "Quick Log", Icon: QuickLogIcon },
    { id: "multi", label: "Full Log", Icon: FullLogIcon }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: theme.spacing.lg, paddingBottom: "120px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: modeConfig.map(({ id, label, Icon }) => {
    ...
    mode === "single" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader$1, { title: "Select Category" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: theme.spacing.md }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: productive.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                style: {
                  ...
                  background: selectedCatId === cat.id ? `${theme.colors.teal}20` : theme.colors.surface,
                  color: selectedCatId === cat.id ? theme.colors.teal : theme.colors.textMuted,
                  fontWeight: 600,
                  fontSize: theme.font.sm,
                  cursor: "pointer",
                  transition: `all ${theme.anim.fast} ease`
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: theme.spacing.lg }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: timeWaste.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setSelectedCatId(cat.id),
                style: {
                  ...
                  background: selectedCatId === cat.id ? `${theme.colors.orange}20` : theme.colors.surface,
                  color: selectedCatId === cat.id ? theme.colors.orange : theme.colors.textMuted,
                  fontWeight: 600,
                  fontSize: theme.font.sm,
                  cursor: "pointer",
                  transition: `all ${theme.anim.fast} ease`
      ...
      selectedCat && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
            background: theme.colors.surface,
          ...
          children: [
            ...
            showOptional && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                  display: "flex",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "label",
                      {
                        ...
                        children: "Session Duration (hours)"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader$1, { title: "Productive" }),
            productive.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              LogField,
              {
                cat,
                value: getValue(cat),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader$1, { title: "Time-Waste" }),
            timeWaste.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              LogField,
              {
                cat,
                value: getValue(cat),
...
function SettingsTab() {
  ...
  const [newCatParent, setNewCatParent] = reactExports.useState(
    "productive"
  );
  const [editingId, setEditingId] = reactExports.useState(null);
  const [editingName, setEditingName] = reactExports.useState("");
  const [storageKB, setStorageKB] = reactExports.useState(0);
  const [importStatus, setImportStatus] = reactExports.useState("");
  const [areYouSure, setAreYouSure] = reactExports.useState(false);
  const fileInputRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    getStorageUsageKB(state).then(setStorageKB);
  }, [state]);
  const updateSetting = (patch) => dispatch({ type: "UPDATE_SETTINGS", payload: patch });
  const addCategory = () => {
  ...
  const toggleTabVisibility = (id) => {
    const hidden = settings.hiddenTabs.includes(id) ? settings.hiddenTabs.filter((h) => h !== id) : [...settings.hiddenTabs, id];
    ...
    reader.onload = (ev) => {
      ...
      try {
        const parsed = JSON.parse(
          (_a3 = ev.target) == null ? void 0 : _a3.result
        );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: theme.spacing.lg, paddingBottom: "100px" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: theme.colors.text }, children: "Tab Bar Layout" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: "Bottom bar or side dock"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToggleButton,
            {
              ...
              onChange: (v) => updateSetting({ navLayout: v })
            }
          )
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Tabs" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: settings.tabOrder.map((tabId, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              display: "flex",
              alignItems: "center",
              padding: theme.spacing.md,
              borderBottom: i < settings.tabOrder.length - 1 ? `1px solid ${theme.colors.border}` : "none",
              gap: theme.spacing.sm
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    flex: 1,
                    fontWeight: 600,
                    color: settings.hiddenTabs.includes(tabId) ? theme.colors.textDim : theme.colors.text
                  },
                  children: TAB_LABELS[tabId]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    background: "none",
                    border: "none",
                    color: settings.hiddenTabs.includes(tabId) ? theme.colors.textDim : theme.colors.accent,
                    cursor: "pointer",
                    fontSize: "16px",
                    padding: "4px"
                  },
                  children: settings.hiddenTabs.includes(tabId) ? "👁️‍🗨️" : "👁️"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    background: "none",
                    border: "none",
                    color: i === settings.tabOrder.length - 1 ? theme.colors.textDim : theme.colors.textMuted,
                    cursor: i === settings.tabOrder.length - 1 ? "default" : "pointer",
                    fontSize: "14px",
                    padding: "4px"
                  },
                  children: "▼"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Categories" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          ...
          productive.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: editingId === cat.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    value: editingName,
                ...
                productive.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
          ...
          timeWaste.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: editingId === cat.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                timeWaste.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    "data-ocid": "settings.delete_button",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "select",
                        {
                          ...
                          style: { ...inputStyle },
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "productive", children: "Productive" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "time-waste", children: "Time-Waste" })
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Slider Scale" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: categories.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              ...
              alignItems: "center",
              padding: theme.spacing.md,
              borderBottom: i < categories.length - 1 ? `1px solid ${theme.colors.border}` : "none"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: theme.colors.text }, children: cat.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: { fontSize: theme.font.xs, color: theme.colors.textDim },
                    children: cat.parentId === "productive" ? "Productive" : "Time-Waste"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Units" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: categories.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: theme.colors.text }, children: cat.name }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ToggleButton,
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Performance" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: theme.colors.text }, children: "Battery Saver Mode" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: "Pokémon GO-style frame rate limiter. 30 FPS saves battery. 60 FPS for smooth animations."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Storage" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: theme.colors.text }, children: "Storage Location" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: "Where your data is saved"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ToggleButton,
              {
                ...
                onChange: (v) => updateSetting({ storageMode: v })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: theme.colors.text }, children: "Storage Used" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: "Approximate size of saved data"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: theme.colors.text }, children: "Export Backup" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: "Download all data as JSON"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: theme.colors.text }, children: "Import Backup" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  style: {
                  ...
                  children: [
                    importStatus === "importing" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: theme.colors.textMuted }, children: "Importing…" }),
                    importStatus === "success" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: theme.colors.success }, children: "✓ Import successful" }),
                    importStatus === "error" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: theme.colors.pink }, children: "✗ Invalid backup file" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: theme.colors.text }, children: "Clear All Data" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                      ...
                      children: "Permanently delete all logs and settings"
                    }
                  )
                ] }),
                !areYouSure ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    "data-ocid": "settings.delete_button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: theme.font.xs, color: theme.colors.textDim }, children: [
          "© ",
...
function AppInner() {
  ...
  const [displayTab, setDisplayTab] = reactExports.useState("home");
  ...
  const tabContent = {
    home: /* @__PURE__ */ jsxRuntimeExports.jsx(HomeTab, {}),
    log: /* @__PURE__ */ jsxRuntimeExports.jsx(LogTab, {}),
    graphs: /* @__PURE__ */ jsxRuntimeExports.jsx(GraphsTab, {}),
    history: /* @__PURE__ */ jsxRuntimeExports.jsx(HistoryTab, {}),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        isSide && /* @__PURE__ */ jsxRuntimeExports.jsx(
          TabBar,
          {
            activeTab,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              paddingBottom: isSide ? 0 : "calc(90px + env(safe-area-inset-bottom))"
            },
            children: tabContent[displayTab]
          }
        ),
        !isSide && /* @__PURE__ */ jsxRuntimeExports.jsx(
          TabBar,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StoreProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppInner, {}) });
}
